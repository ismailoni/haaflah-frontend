        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-700">
            ...
            <li>
              ...
              <pre className="bg-gray-100 p-3 rounded mt-2"><code>git clone https://github.com/your-username/haaflah-frontend.git
cd haaflah-frontend</code></pre>
            </li>
            <li>
              <strong>Set upstream</strong> to keep your fork in sync:
              <pre className="bg-gray-100 p-3 rounded mt-2"><code>git remote add upstream https://github.com/haaflah/haaflah-frontend.git
git fetch upstream</code></pre>
        ...
        <section>
          ...
          <p className="text-gray-700">Install project dependencies. We recommend <code>pnpm</code> but <code>npm</code> or <code>yarn</code> also work.</p>
          <pre className="bg-gray-100 p-3 rounded mt-2"><code>pnpm install
# or
npm install
# or
